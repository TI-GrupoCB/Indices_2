...
logging.basicConfig(level=logging.INFO,filename="log_execucao_python_PS4-400.log", format="%(asctime)s - %(levelname)s - %(message)s ")
    ...
    if df is not None:
        ...
        if Month == 14:
            ...
            if response.status_code == 201:
                print("Dados enviados com sucesso para o SAP BTP - DS4-400.") #Print em tempo de execução
                logging.info("Dados enviados com sucesso para o SAP BTP - DS4-400.") #Log armazenado no fileserver
